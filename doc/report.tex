...
Thus, an accelerometer in free fall would measure $0$, while an accelerometer sitting on a table would measure the normal force that is preventing free fall.
the instantaneous linear acceleration (really the specific force) minus the acceleration due to the (conservative) gravitational field $-g\bm{e}_3$.
\begin{equation}
